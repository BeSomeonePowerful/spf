filename = testlogical.makefile

BIN = ./spflogical

SRC_BIN = main_spf_logical.C
...
${BIN}: ${OBJ_BIN}
	g++ -o ${BIN} ${OBJ_BIN} -lssl -lcrypto -L../_lib/application_test/lib -lpsarsc -ltestlogicaltask -llogtask -L../_lib/xframe/lib -lmysqlclient_r -lhiredis -lxframe
