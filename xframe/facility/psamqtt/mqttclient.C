...
void CMqttClient::wantToSend(CStr &msg)
{
  cout << "###ERROR:calling CMqttClient::wantToSend method" << endl;
}
...
void CMqttClientTcp::wantToSend(CStr &msg)
{
...
void CMqttClientTcpLink::wantToSend(CStr &msg)
{
  TestMessage m;
  m.msgContent = msg;
  wantsToSend.push(m);
...
{
  UniINFO("ClientLink::processRecv method being called");
