...
public:
	...
	enum
	{
		...
		TIXML_ERROR_SETTING_ATTRIBUTES //added by lxm. 2008.12.24
...
protected:
	...
	bool valid; //added by Yubo Chow on Nov 4, 2008
...
public:
	...
	{
		if(_value) //added by lxm. fix core dump. 2008.12.24
			value = _value;
	}
	...
	/// One step up the DOM.
#define RETURN(node) ((node && node->valid) ? node : NULL)
	TiXmlNode* Parent()
	{
	...
	/*This function is added by Yubo Chow on Nov 3, 2008.
	 *
	 * for every child of this node, set it invalid.
	 */
	void Disable();
...
public:
	...
	{
		if( _name) //added by lxm. 2008.12.24. fix core dump.
			name = _name;
		if(_value)
			value = _value;
		document = 0;
	...
	{
		if(_name) //added by lxm. fix core-dump. 2008.12.24
			name = _name;
...
#endif
	void Disable();//added by Yubo Chow on Nov 4, 2008. to set all the attributes invalid.
private:
